...
router.route("/")
    .get(student_controller_1.getStudents)
...
router.route("/search/:searchString").get(student_controller_1.searchStudents);
...
router.route("/:id").get(student_controller_1.getStudent)
