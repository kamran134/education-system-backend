...
router.route("/").get((0, auth_middleware_1.authMiddleware)([]), school_controller_1.getSchools).post((0, auth_middleware_1.authMiddleware)(["superadmin", "admin"]), school_controller_1.createSchool);
